...
#define RCGC_GPIO       (*((volatile uint32_t *)(SYSCTL_BASE | 0x0608)))
#define GPIO_C_AFSEL    (*((volatile uint32_t *) (PORTC_BASE + 0x420)))  
#define GPIO_C_PCTL     (*((volatile uint32_t *) (PORTC_BASE + 0x52C)))

#define UART_DATA(N)   (*((volatile uint32_t *)(UART0_BASE + (0x1000 * N))))
...
UART_status_t UART_Read(uint8_t UART_portNum, uint8_t * data);
